...
class DeleteClassWindow():
    ...
    def creatingClassesFrame(self, root):
        self.classesFrame = Frame(root, bg="#FFFFFF")
    ...
    def creatingBottomFrame(self, root):
        self.bottomFrame = Frame(root, bg="#FFFFFF", highlightbackground="black", highlightthickness=1)
        ...
        self.backToMainWindowButton = Button(self.bottomFrame, image=self.backToMainMenuIcon, bd=0, bg="#FFFFFF",
